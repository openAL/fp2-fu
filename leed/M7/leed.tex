%TODO kohärenz->resolution
%TODO grafiken sinnvoll platzieren am ende
%TODO superstruktur
%TODO fazit
%TODO Referenzen (Literatur) und eventuelle [?] refs korrigieren
%TODO kleinere TODOs z.B. Einheiten der Steigungen
%TODO beliebig formulierungen und grafik platzierung verschÃ¶nern
%TODO letzten (nicht gefitteten Punkt) ind fig:rr mit plotten, x-achsen mit "ohne Einheit" Erwähnung, Einheiten sonst in der Form "E / eV"
...
Linear regression of the remaining measurements (see Figure \ref{fig:rr}) yields a slope $s=\SI{26.6(4)}{}$ which corresponds to a lattice constant 
...
\subfloat[][$E$ as function of $h^2+k^2$]
	{\includegraphics[width=0.6\linewidth]{pic/reflexes.pdf}}

\caption{\small Electron energies at which reflexes $(h,k)$ are projected to opening angle $\varphi=43 \degree$. The value in parentheses does not enter the evaluation as it seems to be too far off. The linear regression (b) results in a slope of $\SI{26.57(36)}{}$ and an axis intercept of $\SI{1.97(36)}{eV}$.}
	\label{fig:rr}
\end{figure}
...
\begin{figure} 
 \centering
\subfloat[][$I(V)$: full range]
{\includegraphics[width=0.5\linewidth]{pic/iv1.pdf}}
\hfill
\subfloat[][$I(V)$: small range, high resolution]
	{\includegraphics[width=0.5\linewidth]{pic/iv2.pdf}}
...
\hfill
\subfloat[][Linear Fit]{
\includegraphics[width=0.5\linewidth]{pic/ivfit.pdf}
}
\caption{\small Optimal matching of $n^2$ to the peak positions. Variance: $\chi_{opt}= 14.2$. Other matchings: $\chi_{other} > 125$. }
	\label{fig:IV2}
\end{figure}
...
\midrule
 ...
 $49$ & $550.16 \pm 0.97$\\
 \bottomrule
\end{tabular} & \includegraphics[width=0.5\linewidth]{pic/ivfit.pdf} \\  
