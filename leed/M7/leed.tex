...
\eq{\lambda = \frac{h}{2m\sqrt{V-U}}.}{lshift}
...
As can be seen from figure \ref{rr}, the function $E(h^2+k^2)$ does not cross the origin. This is can be explained in terms of the kinematic approximation, stating, that the de Broglie wave-length of the electron changes when the electron enters the crystal according to equation \Formel{lshift}. Therefore the aces intercept corresponds to the energy offset $U=\SI{1.97(36)}{eV}$.
