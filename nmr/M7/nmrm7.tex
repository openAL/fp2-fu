...
\subfloat[][$T_2$ (M-G)]
 ...
 \end{tabular}
\caption{
\small \textbf{(a)-(d)} Plots of all four measurement methods for all three concentrations of $CuSO_4$ ($c=0.005$ blue, $c=0.01$ magenta, $c=0.02$ beige). All curves were fitted with a constant noise background (not shown). 
\textbf{(a)} Peak hight in dependence of the time $t$ between $\pi$ and $\pi/2$ pulses of the inversion recovery method. Fitted time constants are $T_1(0.005)=(20.47\pm 0.61)\,\text{ms}$, $T_1(0.01)=(9.64\pm 0.25)\,\text{ms}$, $T_1(0.02)=(4.25\pm 0.11)\,\text{ms}$ (cf. \textbf{(e)}). 
\textbf{(b)} Peak hight in dependence of the time $t$ between $\pi/2$ pulse and echo ($2\tau$) of the spin echo method. Fitted time constants are $T_2(0.005)=(22.0\pm 1.2)\,\text{ms}$, $T_2(0.01)=(9.85\pm 0.47)\,\text{ms}$, $T_2(0.02)=(4.42\pm 0.14)\,\text{ms}$ (cf. \textbf{(f)}). 
\textbf{(c)} Peak hight in dependence of the time $t$ between first and measured peak (spaced at $2\tau$) for the Carr-Purcell method. See running text for details on the fitted model. Fitted time constants are $T_{1,2}(0.005)=(8.68\pm0.87)\,\text{ms}$, $T_{1,2}(0.01)=(5.51\pm 0.46)\,\text{ms}$, $T_{1,2}(0.02)=(2.54\pm 0.51)\,\text{ms}$ (cf. \textbf{(g)}). 
\textbf{(d)} Peak hight in dependence of the time $t$ between first and measured peak (spaced at $2\tau$) for the Meiboom-Gill method. Fitted time constants are $T_2(0.005)=(20.17\pm 0.27)\,\text{ms}$, $T_2(0.01)=(10.17\pm 0.43)\,\text{ms}$, $T_2(0.02)=(4.50\pm 0.20)\,\text{ms}$ (cf. \textbf{(h)}). 
 }
	\label{fig:plots}
\end{figure}
