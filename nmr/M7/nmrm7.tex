...
\subfloat[][$T_2$ (M-G)]
 ...
 \end{tabular}
\caption{
\small \textbf{(a)-(d)} Plots of all four measurement methods for all three concentrations of CuSO$_4$ ($c=0.005$ blue, $c=0.01$ magenta, $c=0.02$ beige). All curves were fitted with a constant noise background (not shown). 
