...
The solution to these ODEs\footnote{
\begin{align}
\frac{1}{2} \text{Abs} &\left[ \frac{1}{\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}}\left(-e^{\frac{t \left(-T_1-T_2-\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 T_1\right.\right.\nonumber\\
&+ e^{\frac{t \left(-T_1-T_2+\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 T_1
+e^{\frac{t \left(-T_1-T_2-\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 T_2\nonumber\\
&- e^{\frac{t \left(-T_1-T_2+\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 T_2
-2 e^{\frac{t \left(-T_1-T_2-\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} y_0 \omega  T_1 T_2\nonumber\\
&+ 2 e^{\frac{t \left(-T_1-T_2+\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} y_0 \omega  T_1 T_2\nonumber\\
&+ e^{\frac{t \left(-T_1-T_2-\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 \sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\nonumber\\
&+ \left.\left. e^{\frac{t \left(-T_1-T_2+\sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)}{2 T_1 T_2}} x_0 \sqrt{T_1^2-2 T_1 T_2+T_2^2-4 \omega ^2 T_1^2 T_2^2}\right)\right]\nonumber
\end{align}
} was fitted to the data resulting in not just information for $T_1$ and $T_2$ but also for the error of the pulses ($\omega$ for the $\pi$ pulse and from the initial conditions for the $\pi/2$ pulse).
