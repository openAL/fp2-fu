...
\caption{
\small Spectrum of Ag generated by \textbf{(a)} Al-$K_\alpha$ x-rays and \textbf{(b)} Mg-$K_\alpha$ x-rays.   } 
	\label{fig:tabelle}
\end{figure}
...
\begin{figure}[h] 
 \centering
\subfloat[][Spectrum]
{  \includegraphics[width=0.8\linewidth]{img/sm.pdf} }       \hfill %
