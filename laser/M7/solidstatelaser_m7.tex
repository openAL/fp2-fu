...
\begin{figure}[p]
\centering
\subfloat[][Calibration of the photodiode]{\includegraphics[width=0.485\textwidth]{img/photoeich.pdf}}
\hfill
...
\begin{tabular}{ccc}
\subfloat[][single pulse]{\includegraphics[width=0.31\textwidth]{img/qsingle.pdf}} &
\subfloat[][resting table]{\includegraphics[width=0.31\textwidth]{img/q1.pdf}} &
\subfloat[][after percussion]{\includegraphics[width=0.31\textwidth]{img/q2.pdf}} \\
\end{tabular}
